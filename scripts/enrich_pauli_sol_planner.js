...
const profiles = {
  ...
  svenska: [
    ...
    P(["huvudidé och detalj","tes och belägg","sammanfattning"],"Anteckningar kopierar texten och produktionen saknar tydlig anknytning till det lästa.","Jämför kopierade meningar med frågestyrda anteckningar.","Använd samma läsmodell på ett reportage om en samhällsfråga."),
